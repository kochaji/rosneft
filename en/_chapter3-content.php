					...
					<div class="chapter">
						<div class="container">
							<div class="row">
								...
								<div class="col-sm-16">
									<h1 class="chapter__title title">Water, Fire <br class="hidden-xs">& Iron Pipes</h1>
					...
					<div class="col-sm-16 col-sm-offset-4">
						...
						<div class="row">
							<p class="col-sm-9 headlineBook preface__header__description headlineBook">
								Present: специальный проект «ИСТОРИЯ НЕФТИ»
							</p>
							...
							<div class="sidebar js-sticky-sidebar">
								<ul class="content-list js-items visible-lg">
									<li class="content-list__item js-item active">
										<a href="#pipeline">Pipeline <!-- быстрого приготовления --></a>
									</li>
									<li class="content-list__item js-item">
										<a href="#nofuel">When there is no fuel left...</a>
									</li>
									<li class="content-list__item js-item">
										<a href="#idea">The Birth of an Idea</a>
									</li>
									<li class="content-list__item js-item">
										<a href="#sum">The Sum of Technologies</a>
									</li>
									<li class="content-list__item js-item">
										<a href="#project">A Project Which Did Not Exist</a>
									</li>
									<li class="content-list__item js-item">
										<a href="#front">The Pipes From the Fighting Line </a>
									</li>
									<li class="content-list__item js-item">
										<a href="#stitches">Seams by the welder Lomonosov
										</a>
									</li>
									<li class="content-list__item js-item">
										<a href="#waves">Above and Under the Waves</a>
									</li>
									<li class="content-list__item js-item">
										<a href="#future">A Route to the Future</a>
									</li>
									<li class="content-list__item js-item">
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-sm-offset-5">
					...
					Fast Preparation Pipeline
					</h2>
					<p>
					Following the development of the Red Army's armaments in the beginning of the 1930s, there was a demand for a rapid improvement in fuel supplies for motorised units. The army was interested in all the latest innovations and it was no wonder that in 1933 the Fuel Supply Office ordered Nefteprovodstroi Trust to design a quick-assembling (as well as quick-disassembling) pipeline for transporting fuel in field conditions. The work was delegated to the young experts Schinberg and Khromov under the guidance of the trust director Georgy Rogachev. 					</p>
					<p>
					The sectional field pipeline had to be 75 mm in diameter and up to 100 km long. About 350 tons of fuel per day had to be pumped through it. The young engineers invented a modular-type pipeline. It consisted of sections 10 km long and delivery measuring stations mounted on cars. 					</p>
					<p>
					A year after the beginning of design activities they were ordered to build a preproduction section of the pipeline 2 km long. The pipeline was to be made of special lightweight pipes which had to be connected by specially designed sleeve joints. In 1935, experts of Nefteprovodstroi Trust together with the army ran petrol transportation tests on the pipeline in Armavir. The army liked the project but the costs were too high because a very small number of lightweight pipes was produced in the USSR and they were quite expensive. 					</p>
					<p>
					Eventually, the Red Army's Fuel Service put the so-called "sectional depot pipeline" into operation at the beginning of 1937. It was much shorter than even the preproduction section designed by Schinberg and Khromov - only 1.5 km long. Still it was a real step forward. 					</p>
					<p>
					Four years later, when Hitler's tank convoys were breaking the Red Army's lines of communication, it became clear that one of the most important supply problems was to rapidly deliver fuel to the functioning armoured units and to refuel them just as rapidly. So in August, 1941, the engineers Shinberg and Khromov wrote to People's Commissar for Oil Industry Ivan Sedin suggesting their 1935 project be revived. 					</p>
					<p>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-offset-5 col-sm-12">
					...
					When there is no fuel left...
					</h2>
					<p>
					The last train left Leningrad at the end of August, 1941. German forces cut off the railway line and were heading north to Lake Ladoga. On September 8, the Wehrmacht reached Shlisselburg, the place where the Neva flows from Lake Ladoga. Finnish forces successfully made their way north of Ladoga closing the ring of the siege. On September 10, the Badaev warehouses with large quantities of supplies were bombed. 					</p>
					<p>
					In September, Hitler with plans to hasten the fall of Moscow in mind, gave the command to call back some tank units from Leningrad, to intensify artillery and air strikes on the city and to begin its systematic destruction. There were lots of refugees from the occupied territories in the city at the time, mainly old men, women and children. They could do nothing to protect the city and were most probably constituted a burden. There was a need to arrange the evacuation of the civilian population from Leningrad so as to improve the supplies for the remaining defenders of the city. Leningrad was running out of provisions and fuel - fuel for military equipment in particular. 					</p>
					<p class="blockquote">
					Leningrad had become an "island" which could be supplied only via Lake Ladoga. But autumn came with the season of Ladoga storms, and the thirty kilometres of water between the eastern and western banks of the lake had to be crossed not only under the enemy's fire but also in the toughest weather conditions. 					</p>
					<p>
					Even Peter the Great had faced the problem of autumn and spring storms on Ladoga, during which the waves, steep and choppy, rose up to 5 metres and blocked vessels with cargoes for building St. Petersburg. Up to a thousand ships of different sizes vanished every year, and due to this fact Peter gave orders to build a canal more than 100 km long along the south coast of Ladoga in 1718. A new canal was built under the reign of Alexander II. This canal is still in use today. 					</p>
					<p>
					The fleet the Soviet side had was too small. Moreover, the enemy successfully sank barges containing people and cargoes. But the winter which was closing in fast brought hope of an ice motor road. Indeed, the "Road of Life" was opened on November 28, 1941. 					</p>
					<p>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-offset-5 col-sm-12">
					...
					<p>
					But in fact, the idea of building an underwater pipeline through the south of Lake Ladoga also occurred to the old friends, Shinberg and Khromov, who were still working for Nefteprovodproekt Trust, which had close contacts with the Red Army's Fuel Service. Sokolova's plan confirmed that the pipeline could be buried on the bottom of the lake, and the Khromov-Shinberg project was elaborated well enough technically as well as technologically. 					</p>
					<p>
					But it would be a mistake to suppose that everyone backed the idea. It was usual for a pipeline to cross a river mounted on the truss of a railway bridge. It was known that on the Sakhalin island, a pipeline a little less than 10 km long was successfully laid under the waters of the Strait of Tartary on March 22. But they welded the sea part of the pipeline when it was still on the surface, and only then put it under water. This was impossible on Lake Ladoga because of the longer length of the line and the inevitable air attacks of the enemy. And also, there was no experience of laying a pipeline at such a distance in open water. 					</p>
					<p>
					So when the idea of an underwater pipeline was made public at the Fuel Service Administration, many experts labelled it at once a pipe dream. Nevertheless, the Head of Administration, General Mikhail Kormilitsin, saw fit to delegate to his subordinates ways of figuring out how to build this line and its potential practicability. 					</p>
					<p>
					As David Schinberg later remembered, there were more questions than answers when the decision to build the pipeline was made. It wasn't clear if they had the necessary quantity of pipes for a start. How shall they connect the pipes with each other: by thread or by weld, and if they choose welding, then what shall they choose - gas or electric welding? How to do this literally in the eye of the enemy? Which tasks could be done in the light of day, and which ones only at night?					</p>
					<p>
					Every time Shinberg met officials they were of a higher rank than before. The next report was to be delivered to Anastas Mikoyan, who was in charge of the whole Red Army's supplies. Mikoyan was the ultimate authority before Stalin, and a report to him was very important. It turned out that the report was delivered by Shinberg, and General Khrulev, who was in command of the rear, inserted some additions. But Mikoyan and Khrulev weren't satisfied with the planned construction time - three months, because the amount of fuel left in Leningrad was only enough for 60 days at most. They agreed that the pipeline was to be built within 50 days. Executives and representatives were rapidly appointed, and David Shinberg took up the post of Head Engineer of the project. A project which to all intents and purposes did not exist. 					</p>
					<!-- img -->
				</div>
			</div>
		</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-offset-5 col-sm-12">
					...
					A Project Which Did Not Exist
					</h2>
					<p>
					To be in charge of such an important and unprepared project means to be held up at gunpoint. There is a huge risk of failure, its consequences will be terribly harsh, and the punishment, taking into account the peculiarities of wartime, can be the severest possible. Schinberg only had old calculations, rough layouts and general plans. He also had the crazy responsibility, particularly to the people who had to bring his plans to life. There also was a deadline - June 20, 1942. 					</p>
					<p>
					At the end of April, Schinberg had the following: the pipeline transmission capacity had to be about 500 tons of petrol per day. To this end, he needed from 35 to 40 km of pipes 100 mm in diameter, transfer pumps and containers to hold the fuel along both banks of Ladoga. 					</p>
					<p>
					There were no pipes at all, and he already had to work out the technology of pipeline construction. The experience Shinberg had with the 1934 project came in handy: 					</p>
					<p class="blockquote">
					the pipes had to be connected in sections and coated with a waterproof layer at first, then assembled in stalks and, as soon as the weather allowed, laid on the bottom of Lake Ladoga. The work had to be carried out most inconspicuously, so that the enemy would understand what was being done on the bank of the lake as late as possible. 					</p>
					<p>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-offset-5 col-sm-12">
					...
					The Pipes From the Fighting Line
					</h2>
					<p>
					From the very moment of taking the decision to build the "OS - 6" facility, the executives in charge contacted the directors of industrial plants and asked them one and the same question: "Do you have any pipes?" They found out that 100 mm diameter pipes made for oil wells were kept in the warehouse of the Izhor plant in Kolpino. There was only one problem - the fighting line ran through the area. 					</p>
					<p>
					Maybe it was because the warehouse with the pipes was very close to the German positions that it was preserved in a relatively good condition. Schinberg went there himself to select the pipes for further transportation to the building site. 					</p>
					<p class="blockquote">
					It turned out that the words "warehouse at the front line" were to be taken at face value. Schinberg with his convoy had hardly started measuring the pipes when an artillery attack began. The warehouse keeper who was in the convoy died. The new pipes were twisted by the force of the explosion and damaged by the shell fragments right in front of their eyes. It was clear that they had to work very gently and only at night.					</p>
					<p>
					On the other hand the pipes were of excellent quality. The thread was protected by special caps, the pipes were marked according to the steel grade and already were base coated. It was simply impossible to lose such a treasure and the pipes were literally carried out by hand. 					</p>
					<p>
					Eventually, the builders of the pipeline had two sorts of pipes. About two thirds of the pipes had no thread, and almost one third of them had a thread and a sleeve joint. A decision was made to weld all the pipes for safety, including those which were first connected by joints. Such connections were to be made between longer stalks at first, welding them in water. 					</p>
					<p>
					As the builders had few high-quality pipes, they decided to transfer the eastern entrance of the route to a protruding land tongue on the eastern bank. They managed to save a few kilometres of the underwater section as a result. The pipes had to be buried at a depth of up to 13 metres. 					</p>
					<p>
					Some "tables" were prepared at the eastern bank near the Kokorevo settlement, where pipes of 5, 6 or, very rarely, 7 metres long were welded together into sections 300 metres long. And the question there was: how good will the welding be? Engineers could do nothing - it was all in the hands of the welders. 					</p>
					<!-- end content -->
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-offset-5 col-sm-12">
					...
					<p>
					After this loss, a decision was made never to work in a storm under any circumstances. The importance of divers grew - they constantly examined the bottom where the pipes were laid. Besides, they were delegated the task of fixing the pipes on the bottom so as they would be stable enough not to be carried away by the current. Cast iron loads weighing 50 kilograms were hung on the pipes. They were hung every fifty metres at a depth of less than four metres, and half as frequently again at a greater depth. 					</p>
					<p>
					In shallow waters and the coastal area the pipes were buried with the help of a jet gun breaking the sandy and muddy bottom. Thus both ends of the pipeline were made inconspicuous against the background of the traditional crossings which were still functioning. Camouflage and active lake navigation allowed for keeping the pipeline works secret. 					</p>
					<p>
					Stalk laying was started on May 31. The EPRON men worked almost ceaselessly. The engineer diver Sokolova did a considerable amount of dives together with her colleagues. The welders who worked on the shore increased the speed of work - they could already weld three sections per day, that is, almost one kilometre. In two weeks, on June 14, the last stalk, the fifteenth, was welded to the pipeline. The pipeline was laid across Lake Ladoga. 					</p>
					<p>
					But this didn't mean the end of the work. The divers once again checked the pipeline all the way along its length. The bend radii conformed to all of the project parameters. There was no sagging. Then the tests began - they started with piping in some water. After that they pumped in kerosene, gradually increasing the pressure. Finally they injected kerosene in the pipeline under pressure of more than 20 atm and started watching the manometers. The divers checked the joints trying to find some points of leakage but there were none. Three days later, on June 18, the pipeline was ready to be put into operation. 					</p>
					<!-- end content -->
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-offset-5 col-sm-12">
					...
					<p>
					But Italian MAS naval launches began operations on Lake Ladoga three days later. They were relocated purposely on German warships to Finland and further - using the railway, to impede water transportation of Soviet cargoes across Ladoga. Besides, the Germans forwarded 6 combat launches to Lake Ladoga in May, each one armed with two AA rapid-fire guns and bearing underwater mines. 					</p>
					<p>
					Landing craft armed with 88 mm main guns and 20 mm AA rapid-fire guns were brought to the location after a short while. Thus, that same summer of 1942 a joint Finnish, Italian and German flotilla consisting of more than 40 battle units (not counting sixty communication support boats) started operating against the Soviet lines of communication on Ladoga. 					</p>
					<p>
					The Luftwaffe also constantly delivered air strikes along the route. But nevertheless the underwater pipeline functioned without failure. 50 thousand tons of fuel were delivered down this pipeline and it was switched off only after the lifting of the siege. 					</p>
					<p class="blockquote">
					Captured documents revealed that the Germans didn't know about the pipeline and its role in supplying the defenders of the city with fuel. 					</p>
					<p>The experience of building the Ladoga pipeline was used almost immediately.
					</p>
					<p>
					Sectional field pipelines became more popular for transferring fuel across small water barriers. And already in April 1943, a more serious task arose. The EPRON experts from Lake Ladoga and Sakhalin were invited to complete this task - they had to lay a long-distance pipeline across the Volga. Pipelines were laid across the Dnieper in 1944 and the Vistula in 1945. In total, more than 1200 km of pipelines were laid during the war, and many of them across water barriers. 					</p>
					<!-- end content -->
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-offset-5 col-sm-12">
					...
					<p>
					The story of building the Ladoga pipeline is a story of brilliantly organised production where military supply services were involved alongside of the units of the Navy (EPRON) and civic design organisations. They managed to wade through departmental barriers, create a new organisation and fulfil a most difficult task with excellent quality and ahead of schedule. 					</p>
					<p>
					As it happens, these people wouldn't meet the definition of "heroes" in the Soviet era. But as the time goes by, it becomes clear that they possessed what was needed back then and what we lack nowadays - the skill to do one's job in a clear, creative and effective manner - and with minimal losses. In a word, professionally.   					</p>
					<p>
						No one would be amazed by the pipeline itself these days. But the case of successful organisation and management is worth a careful examination and builders themselves should be honoured and well remembered. As every long-distance pipeline that negotiates water barriers or is hidden under the waves of rough seas is the descendant of that very pipeline. </p> 					<p class="strange-square text-center">◼</p>
						<!-- end content -->
					</div>
				</div>
			</div>
